...
mixin _$AuthSessionDto {
 ...
 String get accessToken; String get refreshToken; DateTime get expiresAt; String get userId; String get email; String get displayName;
...
bool operator ==(Object other) {
  final _this = this as AuthSessionDto;
...
int get hashCode {
  final _this = this as AuthSessionDto;
  return Object.hash(runtimeType,_this.accessToken,_this.refreshToken,_this.expiresAt,_this.userId,_this.email,_this.displayName);
}
...
@useResult
$Res call({
 String accessToken, String refreshToken, DateTime expiresAt, String userId, String email, String displayName
});
...
/// Create a copy of AuthSessionDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? refreshToken = null,Object? expiresAt = null,Object? userId = null,Object? email = null,Object? displayName = null,}) {
  return _then(AuthSessionDto(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  DateTime expiresAt,  String userId,  String email,  String displayName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSessionDto() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.expiresAt,_that.userId,_that.email,_that.displayName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  DateTime expiresAt,  String userId,  String email,  String displayName)  $default,) {final _that = this;
switch (_that) {
case _AuthSessionDto():
return $default(_that.accessToken,_that.refreshToken,_that.expiresAt,_that.userId,_that.email,_that.displayName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  DateTime expiresAt,  String userId,  String email,  String displayName)?  $default,) {final _that = this;
switch (_that) {
case _AuthSessionDto() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.expiresAt,_that.userId,_that.email,_that.displayName);case _:
  return null;
...
class _AuthSessionDto extends AuthSessionDto {
  const _AuthSessionDto({required this.accessToken, required this.refreshToken, required this.expiresAt, required this.userId, required this.email, this.displayName = ''}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,accessToken,refreshToken,expiresAt,userId,email,displayName);
}
...
/// Create a copy of AuthSessionDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? refreshToken = null,Object? expiresAt = null,Object? userId = null,Object? email = null,Object? displayName = null,}) {
