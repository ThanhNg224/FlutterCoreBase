...
mixin _$Post {
 ...
 int get id; String get title; String get body; int get userId; List<String> get tags; DateTime? get createdAt;
...
@useResult
$Res call({
 int id, String title, String body, int userId, List<String> tags, DateTime? createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String body,  int userId,  List<String> tags,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Post() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String body,  int userId,  List<String> tags,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _Post():
return $default(_that.id,_that.title,_that.body,_that.userId,_that.tags,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String body,  int userId,  List<String> tags,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Post() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.userId,_that.tags,_that.createdAt);case _:
  return null;
...
class _Post implements Post {
  const _Post({required this.id, required this.title, required this.body, this.userId = 1,  List<String> tags = const <String>[], this.createdAt}): _tags = tags;
